...
# Since I am modifying a JSON, I should be careful not to replace keys.
# But in this file, these words are only in values.
# I'll use a safer way: only replace in values.
