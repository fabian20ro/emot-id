          ...
          return (
            <span key={emotion.id} className="inline-flex items-center gap-1">
              ...
              <motion.button
                ...
                className={`px-2 py-1 min-h-[44px] min-w-[44px] inline-flex items-center justify-center rounded-full text-sm font-medium transition-colors hover:bg-white/10 ${isCurrent ? 'ring-2 ring-white/50' : ''}`}
